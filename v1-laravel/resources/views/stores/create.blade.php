...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-900 mt-2">Add Store</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('stores.store') }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">{{ old('address') }}</textarea>
                </div>
                <div>
            ...
            <div class="flex justify-end mt-6 space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700">Save Store</button>
            </div>
        </form>
    </div>
</div>
