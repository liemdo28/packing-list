...
export default function ItemsCreate({ categories = [], units = [] }) {
    ...
    return (
        <Layout>
            ...
            <div className="max-w-2xl mx-auto">
                <h1 className="text-2xl font-bold text-white mb-6">Create Item</h1>
                ...
                <form onSubmit={handleSubmit} className="bg-[#1e1e2e] border border-gray-700/50 shadow-lg rounded-lg p-6 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button type="submit" disabled={processing} className="rounded-md bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 disabled:opacity-50">{processing ? 'Creating...' : 'Create Item'}</button>
                    </div>
                </form>
            </div>
        </Layout>
